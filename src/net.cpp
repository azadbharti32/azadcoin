...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Azadcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"azadcointools.com", "192.169.244.186"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"azadcointools.com", "testnet-seed.azadcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Azadcoin is probably already running."), addrBind.ToString().c_str());
        else
